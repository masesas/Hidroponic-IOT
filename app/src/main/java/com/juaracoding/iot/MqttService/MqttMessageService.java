...
public class MqttMessageService extends Service {
    ...
    public void onCreate() {
        ...
        sp = new SharePreferencesHelper(getApplicationContext());
        if(sp.getSPServer() != null){
            mqttAndroidClient = pahoMqttClient.getMqttClient(getApplicationContext(), sp.getSPServer(), Constants.CLIENT_ID);
        }
